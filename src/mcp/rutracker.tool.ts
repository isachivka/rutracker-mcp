  ...
  @Tool({
    ...
    parameters: z.object({
      query: z.string().describe(`
        ...
        Слова "сезон/ серия" всегда пишут на русском. 
        
        Поиск работает плохо, например если ты ищешь "Серия" а в названии написано "Серии", то ничего не найдется.
        Поэтому попробуй разные варианты написания если ничего не находится.
